...
namespace Scribbly.Cubby.UnitTests.Tests.Serializers.Compression;

public class GZIP_Compression_Tests
{
    [Theory]
    [InlineData(5_599)]
    [InlineData(65_535)]
    ...
    public void Given_ByteArray_Compress_Should_Reduce_Size(int length)
    {
        ...
        var result = array.AsSpan().GzipCompress();
    ...
    public void Given_Compressed_ByteArray_Decompress_Should_Match_Compressed(int length)
    {
        ...
        var decompressed = result.GzipDecompress();
