...
public class HttpApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    /// <summary>
        ...
        try
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.AddCubbyClient(ops =>
                    ...
                    .WithCubbyHttpClient(httpOptions =>
                    {
                        httpOptions
                            .ConfigurePrimaryHttpMessageHandler(sp => 
                            { 
                                var factory = sp.GetRequiredService<HttpApplicationFactory>();
