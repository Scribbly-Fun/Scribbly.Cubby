...
public class AddHttpCubbyClient_With_DefaultOptions_ServiceExtension_Tests : IAsyncLifetime
{
    ...
    [Fact]
    public void AddCubbyClient_Should_Register_IHttpCubbyClient() 
        => _provider.GetService<IHttpCubbyClient>().Should().NotBeNull();

    [Fact]
    public void AddCubbyClient_Should_Register_IHttpCubbyClient_As_HttpCubbyClient()
        => _provider.GetService<IHttpCubbyClient>().Should().BeAssignableTo<HttpCubbyClient>();
